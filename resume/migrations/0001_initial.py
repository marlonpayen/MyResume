    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proficiency', models.CharField(choices=[('1', 'Elementary'), ('2', 'Limited Working'), ('3', 'Professional Working'), ('4', 'Full Professional'), ('5', 'Native')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Skill',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30)),
                ('proficiency', models.CharField(choices=[('1', 'Beginner'), ('2', 'Intermediate'), ('3', 'Proficient'), ('4', 'Expert')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='WorkExperience',
